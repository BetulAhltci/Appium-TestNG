...
// uygulamayi kapatalim
    ...
    public void setup() throws MalformedURLException {
        ...
        // uygulamada hangi sayfayi gormek veya baslatmak istedgimiz
    ...
    public void arabamTest() throws InterruptedException {
        ...
        // Wolkswagen markasini secelim (ekranı yukardan asagı kaydır)
       ...
       /* //Ekranı alttan yukarı kaydırır
        ...
        // Versiyon secimi yapalim
        Thread.sleep(1000);
        action.press(PointOption.point(453,1747)).release().perform();

        // aracin km bilgilerini girelim
        if (driver.isKeyboardShown()){
            driver.getKeyboard().pressKey("190000");
        }else{
            driver.findElement(By.id("com.dogan.arabam:id/et_km")).sendKeys("150000");
        }
        driver.findElement(By.id("com.dogan.arabam:id/btn_price_prediction_submit"));
        ...
        //Temer kaydı yok secenegini sec
        driver.findElement(By.id("com.dogan.arabam:id/rbHasNoTramerEntry")).click();
        driver.findElement(By.id("com.dogan.arabam:id/btnNext")).click();

        // aracimizin fiyatinin 500.000 tl den fazla oldugunu test edelim
        String avaragePrice=driver.findElement(By.id("com.dogan.arabam:id/tvAveragePrice")).getText();
        //588.500 TL
